// Absolute dynamic placement => browser current view port
// Calculate Page Size and View Port Dimension Tools
...
window.onload = function() {
 ...
 //Here is an example that will update just the scroll offset and reposition the element 
